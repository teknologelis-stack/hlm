...
try {
    ...
    logAction('bridge_ports_viewed', 'Bridge portları görüntülendi', $mikrotik->device['id'] ?? null);
    ...
    error_log("Bridge ports error: " . $e->getMessage());
    jsonResponse([
        'success' => false,
